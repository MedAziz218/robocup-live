<script lang="ts" context="module">
	import { z } from "zod";
	export const autonomousFormSchema = z.object({
		username: z
			.string()
	...
	export type AutonomousFormSchema = typeof autonomousFormSchema;
</script>
...
<script lang="ts">
	...
	export let data: SuperValidated<Infer<AutonomousFormSchema>>;

	const form = superForm(data, {
		validators: zodClient(autonomousFormSchema),
	});
