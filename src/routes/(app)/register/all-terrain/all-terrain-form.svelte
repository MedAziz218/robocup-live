<script lang="ts" context="module">
	...
	export type AllTerrainFormSchema = typeof allTerrainFormSchema;
</script>
...
<script lang="ts">
	...
	export let data: SuperValidated<Infer<AllTerrainFormSchema>>;

	const form = superForm(data, {
		validators: zodClient(allTerrainFormSchema),
	});
