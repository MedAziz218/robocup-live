<script lang="ts" context="module">
	import { z } from "zod";
	export const juniorFormSchema = z.object({
		username: z
			.string()
	...
	export type JuniorFormSchema = typeof juniorFormSchema;
</script>
...
<script lang="ts">
	...
	export let data: SuperValidated<Infer<JuniorFormSchema>>;

	const form = superForm(data, {
		validators: zodClient(juniorFormSchema),
	});
